...
3. Move towards a single OpenMP and OpenBLAS on PyPI by shipping an OpenMP and OpenBLAS wheel. NumPy, SciPy, and Scikit-learn will link to those libraries during runtime, thus allowing the libraries to share the same threadpool. Please see the [technical details section](#how-to-ship-openmp-and-openblas-on-pypi) on how this could work.
