...
- SciPy's `linalg` module uses OpenBLAS, which is also multi-threaded by default and built with pthreads. Functions with the `workers` parameter may use multiprocessing, multithreading, or pthreads.
