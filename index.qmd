...
Yes, this design documentation does **not** restrict the usage of other API for parallalism. If Python's `multithreading` or `multiprocessing` fits your libraries use case, you are welcome to use them.
