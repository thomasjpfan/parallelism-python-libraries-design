...
### Proposal
Here is a possible two step solution:
...
- Adopt a consistent Python API for configuring parallelism. We use SciPy's `workers` parameter, because it is more consisntet in controlling the number of cores used.
