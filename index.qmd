...
- SciPy's `linalg` module uses OpenBLAS, which is also multi-threaded by default and built with pthreads. SciPy also has a `workers` parameter that may multiprocessing, multithreading, or pthreads.
